        ...
        <div className="max-w-3xl w-full">
          <Card className="animate-scale-in shadow-xl">
            <CardContent className="py-12 sm:py-16 text-center">
              ...
              <p className="text-base sm:text-lg text-stone-200 mb-6 sm:mb-8 max-w-lg mx-auto leading-relaxed px-4">
              ...
              <div className="mb-10 max-w-md mx-auto">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-xs font-semibold text-stone-200">Progression</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10 max-w-2xl mx-auto">
                <div className="group p-4 sm:p-5 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100/50 border-2 border-orange-200 hover:border-orange-400 transition-all hover:shadow-lg hover:-translate-y-1 duration-200">
                  ...
                  <h3 className="font-bold text-sm sm:text-base text-stone-50 mb-1">Gestion des Quiz</h3>
                  <p className="text-xs sm:text-sm text-stone-200">Créer et modifier vos QCM facilement</p>
                </div>
                ...
                <div className="group p-4 sm:p-5 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100/50 border-2 border-orange-200 hover:border-orange-400 transition-all hover:shadow-lg hover:-translate-y-1 duration-200">
                  ...
                  <h3 className="font-bold text-sm sm:text-base text-stone-50 mb-1">Catégories</h3>
                  <p className="text-xs sm:text-sm text-stone-200">Organiser vos quiz par thème médical</p>
                </div>
                ...
                <div className="group p-4 sm:p-5 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100/50 border-2 border-orange-200 hover:border-orange-400 transition-all hover:shadow-lg hover:-translate-y-1 duration-200">
                  ...
                  <h3 className="font-bold text-sm sm:text-base text-stone-50 mb-1">Banque de Questions</h3>
                  <p className="text-xs sm:text-sm text-stone-200">Gérer et enrichir votre base</p>
                </div>
                ...
                <div className="group p-4 sm:p-5 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100/50 border-2 border-orange-200 hover:border-orange-400 transition-all hover:shadow-lg hover:-translate-y-1 duration-200">
                  ...
                  <h3 className="font-bold text-sm sm:text-base text-stone-50 mb-1">Statistiques</h3>
                  <p className="text-xs sm:text-sm text-stone-200">Analyser les performances</p>
                </div>
              </div>
