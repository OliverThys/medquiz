...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-orange-50/20 to-stone-50 flex flex-col">
      <Header />
            ...
            <CardContent className="py-12 sm:py-16 text-center">
              ...
              <div className="mb-8 flex justify-center">
                <div className="relative group">
                  ...
                  <div className="relative w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-orange-400 via-orange-500 to-orange-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                    <svg
                  ...
                  {/* Badge animé */}
                  <div className="absolute -top-2 -right-2 w-8 h-8 sm:w-10 sm:h-10 bg-orange-500 rounded-full flex items-center justify-center animate-bounce">
              ...
              {/* Titre avec gradient */}
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 bg-gradient-to-r from-stone-900 via-orange-600 to-stone-900 bg-clip-text text-transparent">
                Administration
              </h1>
              ...
              <div className="mb-10 max-w-md mx-auto">
                ...
                <div className="w-full bg-stone-200 rounded-full h-4 overflow-hidden shadow-inner">
                  <div
                    className="h-full bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 transition-all duration-1000 ease-out relative"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-10 max-w-2xl mx-auto">
                <div className="group p-4 sm:p-5 rounded-xl bg-gradient-to-br from-orange-50 to-orange-100/50 border-2 border-orange-200 hover:border-orange-400 transition-all hover:-translate-y-1 duration-200">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 rounded-lg bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center group-hover:scale-110 transition-transform">
