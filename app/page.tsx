      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="text-center mb-12 animate-fade-in">
          <h1 className="text-4xl sm:text-5xl font-bold text-neutral-900 dark:text-neutral-100 mb-4">
            Révision Médicale <span className="text-orange-500 dark:text-orange-400">Interactive</span>
          </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          <Card className="text-center">
            <CardContent className="py-6">
              <div className="text-3xl font-bold text-orange-500 dark:text-orange-400 mb-1">{categories.length}</div>
              <div className="text-sm text-neutral-600 dark:text-neutral-400">Catégories</div>
            </CardContent>
          </Card>
          <Card className="text-center">
            <CardContent className="py-6">
              <div className="text-3xl font-bold text-orange-500 dark:text-orange-400 mb-1">{totalQuizzes}</div>
              <div className="text-sm text-neutral-600 dark:text-neutral-400">QCM disponibles</div>
            </CardContent>
          </Card>
          <Card className="text-center">
            <CardContent className="py-6">
              <div className="text-3xl font-bold text-orange-500 dark:text-orange-400 mb-1">{totalQuestions}</div>
              <div className="text-sm text-neutral-600 dark:text-neutral-400">Questions totales</div>
            </CardContent>
          </Card>
        </div>
            ...
            {categories.map((category) => (
              <div key={category.id} className="animate-fade-in">
                ...
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">{category.name}</h2>
                ...
                {category.quizzes.length > 0 ? (
                    ...
                    {category.quizzes.map((quiz: any) => {
                      ...
                      return (
                        <Link key={quiz.id} href={`/quiz/${quiz.id}`}>
                          <Card hover className={`h-full ${isComprehensiveQuiz ? 'bg-gradient-to-br from-orange-50 to-white dark:from-orange-950/20 dark:to-neutral-900 border-orange-200 dark:border-orange-900' : ''}`}>
                            ...
                            {quiz.description && (
                              <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4 line-clamp-2">{quiz.description}</p>
                            )}
                  ...
                  <Card>
                    <CardContent className="text-center py-8 text-neutral-500 dark:text-neutral-400">
